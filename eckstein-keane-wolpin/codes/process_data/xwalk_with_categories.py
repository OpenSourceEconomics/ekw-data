...
extended_white_col = {'Legislators': 3, 'Chief executives and public administrators': 4,
                      ...
                      'Medical scientists': 83, 'Respiratory therapists': 98,
                      'Occupational therapists': 99, 'Physical therapists': 103,
                      'Speech therapists': 104,
                      'Humanities profs/instructors, college, nec': 150,
                      'Special education teachers': 158, 'Technical writers': 184,
                      'Professionals, n.e.c.': 200,
                      'Legal assistants, paralegals, legal support, etc': 234, 
                      'Supervisors and proprietors of sales jobs': 243,
                      'Sales workers--allocated (1990 internal census)': 290, 'Hotel clerks': 317,
                      'Information clerks, nec': 323, 'Correspondence and order clerks': 326,
                      'Records clerks': 336,
...
extended_blue_col = {'Physicians assistants': 106, 'Protective services, n.e.c.': 427,
                     ...
                     'Guides': 461, 'Marine life cultivation workers': 483,
                     ...
                     'Sheet metal duct installers': 596, 'Drillers of oil wells': 614,
                     'Other mining occupations': 617,
                     'Precision grinders and filers': 644, 'Other precision woodworkers': 659, 
                     'Other precision and craft workers': 684, 'Batch food makers': 688,
...
print(crosswalk[['OCC1990', 'DESCRIPTION']][crosswalk['CATEGORY'].isna() &
                                            ~crosswalk['OCC1990'].isin(occ_not_needed)])
...
crosswalk.drop(columns=['category_aux']).\
    to_pickle('../../output/data/interim/categorized_xwalk.pkl')
