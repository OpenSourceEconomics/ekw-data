...
original_ext_df = pd.read_csv(PROJECT_DIR / "eckstein-keane-wolpin/material/sources/original.csv",
                              index_col="R0000100")

shutil.copyfile(PROJECT_DIR / "eckstein-keane-wolpin/material/sources/original.sdf",
                PROJECT_DIR / "sources/original_extended.sdf")
file_dict = {}

with open(PROJECT_DIR / "eckstein-keane-wolpin/material/sources/unrevised_educ_vars.sdf",
          "r") as file:
    filedata = file.read()
...
for filename in [
    ...
    with open(PROJECT_DIR / "eckstein-keane-wolpin/material/sources/original_extended.sdf",
              "r") as original_ext_description:
        lineset = set(original_ext_description)
    with open(PROJECT_DIR / "eckstein-keane-wolpin/material/sources/original_extended.sdf",
              "a") as original_ext_description:
        with open(
                PROJECT_DIR / "eckstein-keane-wolpin/material/sources/" + filename + ".sdf") as infile:
